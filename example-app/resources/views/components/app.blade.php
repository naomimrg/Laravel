...
<div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
    <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Hwang Oppaa</h2>
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700 {{ request()->routeIs('index') ? 'bg-gray-500' : ''}}"
            href="{{ route('index') }}">
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700 {{ request()->routeIs('contact') ? 'bg-gray-500' : ''}}"
            href="{{ route('contact') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700 {{ request()->routeIs('description') ? 'bg-gray-500' : ''}}"
        ...
        <div class="flex items-center px-4 -mx-2">
            ...
            src="https://i.pinimg.com/236x/39/f8/81/39f88128dc840d78bf36bedc506b7978.jpg" alt="sayangg"/>
            <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Hwang Inyeop</h4>
        </div>
    </div>
</div>
